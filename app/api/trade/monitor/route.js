...
export async function GET(request) {
  ...
  try {
    ...
    let cashBalance = { availableMoney: 0, availableUsdt: 0, availableUsdc: 0, usdcBalance: 0, total: 0 };
